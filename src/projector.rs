...
mod test {
    ...
    fn get_value() {
        ...
        assert_eq!(proj.get_value("fem"), Some(&String::from("baz")));
    }
    ...
    fn set_value() {
        ...
        proj.set_value(String::from("fem"), String::from("bazbaz"));

        assert_eq!(proj.get_value("foo"), Some(&String::from("bar4")));
        assert_eq!(proj.get_value("fem"), Some(&String::from("bazbaz")));
    }

    #[test]
    fn remove_valuset_valuee() {
        let mut proj = get_projector(PathBuf::from("/foo/bar"));
